...
if($_SERVER['REQUEST_METHOD']=="POST")
{
	...
	$_SESSION['amount']=2000*$days;
	$_SESSION['m_type']=$_SESSION['brand'];
	$_SESSION['tempo_type']=$_SESSION['tempo1'];
...
<body>
<div class="navbar">
<a class="subname" href="tempo.php"><?php echo$_SESSION['c_name']?> - <?php echo $_SESSION['brand'];?></a>
</div>
<main>
<div class="prod">
<div class="imgdis">
<img class="myslide" src="<?php echo $_SESSION['tempo1'];?>">
<img class="myslide" src="<?php echo $_SESSION['tempo1.1'];?>">
<img class="myslide" src="<?php echo $_SESSION['tempo1.2'];?>">
<img class="bnt" onclick="plus(1)" src="<?php echo $_SESSION['tempo1'];?>">
<img class="bnt" onclick="plus(2)" src="<?php echo $_SESSION['tempo1.1'];?>">
<img class="bnt" onclick="plus(3)" src="<?php echo $_SESSION['tempo1.2'];?>">
<script type="text/javascript" src="js/final-product.js"></script>
</div>
<div class="details">
<form action="1-tempo.php" method="post" >
<div class="form">
