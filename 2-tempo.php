...
if($_SERVER['REQUEST_METHOD']=="POST")
{
	...
	$_SESSION['amount']=4000*$days;
	$_SESSION['m_type']=$_SESSION['brand1'];
	$_SESSION['tempo_type']=$_SESSION['tempo2'];
	if($r_num==8){
...
<html>
<title><?php echo $_SESSION['brand1'];?></title>
<head>
<link rel="stylesheet" href="css/home.css">
</head>
<body>
<div class="navbar">
<a class="subname" href="tempo.php"><?php echo$_SESSION['c_name']?> - <?php echo $_SESSION['brand1'];?></a>
</div>
<main>
<div class="prod">
<div class="imgdis">
<img class="myslide" src="<?php echo $_SESSION['tempo2'];?>">
<img class="myslide" src="<?php echo $_SESSION['tempo2.1'];?>">
<img class="myslide" src="<?php echo $_SESSION['tempo2.2'];?>">
<img class="bnt" onclick="plus(1)" src="<?php echo $_SESSION['tempo2'];?>">
<img class="bnt" onclick="plus(2)" src="<?php echo $_SESSION['tempo2.1'];?>">
<img class="bnt" onclick="plus(3)" src="<?php echo $_SESSION['tempo2.2'];?>">
<script type="text/javascript" src="js/final-product.js"></script>
</div>
<div class="details">
<form action="2-tempo.php" method="post" >
<div class="form">
<h1> <?php echo $_SESSION['brand1'];?></h1>
<br>
<span class="date">
