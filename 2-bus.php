...
if($_SERVER['REQUEST_METHOD']=="POST")
{
	...
	$_SESSION['amount']=6890*$days;
	$_SESSION['m_type']=$_SESSION['brand1'];
	$_SESSION['tempo_type']=$_SESSION['bus2'];
	if($r_num==4){
...
<body>
<div class="navbar">
<a class="subname" href="bus.php"><?php echo$_SESSION['c_name']?> - <?php echo $_SESSION['brand1'];?></a>
</div>
<main>
<div class="prod">
<div class="imgdis">
<img class="myslide" src="<?php echo $_SESSION['bus2'];?>">
<img class="myslide" src="<?php echo $_SESSION['bus2.1'];?>">
<img class="myslide" src="<?php echo $_SESSION['bus2.2'];?>">
<img class="bnt" onclick="plus(1)" src="<?php echo $_SESSION['bus2'];?>">
<img class="bnt" onclick="plus(2)" src="<?php echo $_SESSION['bus2.1'];?>">
<img class="bnt" onclick="plus(3)" src="<?php echo $_SESSION['bus2.2'];?>">
<script type="text/javascript" src="js/final-product.js"></script>
</div>
<div class="details">
<form action="2-bus.php" method="post" >
<div class="form">
