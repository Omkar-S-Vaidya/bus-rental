...
if($_SERVER['REQUEST_METHOD']=="POST")
{
	...
	$_SESSION['tempo_type']=$_SESSION['van1'];
	if($r_num==2){
...
<body>
<div class="navbar">
<a class="subname" href="van.php"><?php echo$_SESSION['c_name']?> - <?php echo $_SESSION['brand1'];?></a>
</div>
<main>
<div class="prod">
<div class="imgdis">
<img class="myslide" src="<?php echo $_SESSION['van2'];?>">
<img class="myslide" src="<?php echo $_SESSION['van2.1'];?>">
<img class="myslide" src="<?php echo $_SESSION['van2.2'];?>">
<img class="bnt" onclick="plus(1)" src="<?php echo $_SESSION['van2'];?>">
<img class="bnt" onclick="plus(2)" src="<?php echo $_SESSION['van2.1'];?>">
<img class="bnt" onclick="plus(3)" src="<?php echo $_SESSION['van2.2'];?>">
<script type="text/javascript" src="js/final-product.js"></script>
</div>
<div class="details">
<form action="2-van.php" method="post" >
<div class="form">
